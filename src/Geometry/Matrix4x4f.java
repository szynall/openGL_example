...
public void rotate( float angle, Vector3 axis )
{
    ...
    m[4]  = (1-c) * uy*ux - s*uz;
    m[5]  = (float) (c + (1-c) * Math.pow(uy,2));
    m[6]  = (1-c) * uy*uz + s*ux;
    m[7]  = 0;
    
    m[8]  = (1-c) * uz*ux + s*uy;
    m[9]  = (1-c) * uz*uz - s*ux;
    m[10] = (float) (c + (1-c) * Math.pow(uz,2));
    m[11] = 0;
...
Matrix4x4f add ( Matrix4x4f other )
{
    Matrix4x4f result = null;
...
Matrix4x4f sub ( Matrix4x4f other )
{
    Matrix4x4f result = null;
...
Matrix4x4f multiply ( Matrix4x4f other )
{
    Matrix4x4f result = null;
...
Matrix4x4f multiplyScalar ( float scalar )
{
    Matrix4x4f result = null;
